<style type="text/css">
	/* TEMPLATE CSS */	
	.cpvg-record{border: 1px solid #8CACBB;background-color: #DEE7EC;padding: 10px;margin-top:10px;margin-bottom:10px;-webkit-background-size: 100%;-o-background-size: 100%;-khtml-background-size: 100%;-moz-border-radius: 8px;-webkit-border-radius: 8px; }
